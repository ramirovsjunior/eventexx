...
class SubscribePostTest(TestCase):
    ...
    def test_post(self):
        """Valid POSR should redirect to /inscricao/"""
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Ramiro Júnior', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('ramirojunior@outlook.com', email.body)
...
class SubscribeSucessMessage(TestCase):
    def test_message(self):
        data = dict(name='Ramiro Júnior', cpf='12345678901',
                    email='ramirovsjunior@mailinator.com', phone='21-99618-6180')
